...
function Header({view}:{view:View}){return <header className="topbar"><a className="logo" href="#home"><i>R</i><b>RSL<span>VALUE</span></b></a><nav><a className={view==='home'?'active':''} href="#home">Главная</a><a className={view==='estimate'?'active':''} href="#estimate">Оценка</a><a className={view==='market'?'active':''} href="#market">Купить</a></nav><a className="ghost header-buy" href="#market">Купить аккаунт</a></header>}
