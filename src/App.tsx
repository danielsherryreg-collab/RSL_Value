...
function Header(_props:{view:View}){return <header className="topbar"><a className="logo" href="#home"><i>R</i><b>RAID <span>STORE</span></b></a><a className="ghost header-buy" href="#market">Купить аккаунт</a></header>}
function Footer(){return <footer><div className="logo"><i>R</i><b>RAID <span>STORE</span></b></div><p>Оценка аккаунтов RAID: Shadow Legends. Не связан с Plarium Global Ltd.</p><a href="#home">Наверх ↑</a></footer>}
